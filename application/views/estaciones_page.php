  ...
  <div id="wrapper">
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="<?=base_url('estaciones');?>"><i class="fas fa-map-marked-alt"></i>  Estacion</a>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <button class="btn btn-primary" data-target="#universalModal" data-toggle="modal">
		    ...
		    <!-- begin modal form -->
		    <div class="modal fade" id="universalModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
		        <div class="modal-dialog" role="document">
		          <div class="modal-content">
		            <div class="modal-header">
		              <h5 class="modal-title" id="exampleModalScrollableTitle">Agregar Estacion</h5>
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control" id="system" name="system">
		              ...
		              <div class="form-group">
		                <label>Nombre</label>
		                <input type="text" id="nameStation" name="name" class="form-control">
                    <span id="name-error"></span>
		              </div>
                  <div class="form-group">
                    <label>Latitud</label>
                    <input type="text" id="latitudeStation" name="latitude" class="form-control">
                    <span id="latitude-error"></span>
                  </div>
                  <div class="form-group">
                    <label>Longitud</label>
                    <input type="text" id="longitudeStation" name="longitude" class="form-control">
                    <span id="longitude-error"></span>
                  </div>
		              
		              <div class="form-group btns">
		                    <button type="button" class="btn  btn-block btn-primary btn-post">Guardar</button>
		              </div>
		            </div>
		            </form>
...
<script type="text/javascript">
    ...
    // begin function get
      var table_var = $(document).find('#exportTable').DataTable({
          ajax : {
            'url':'http://localhost/envirmonitoring/index.php/Station/api/stationview',
            'dataSrc':'data',
             headers :{
              'X-API-KEY':'QWERTY'
            },
          ...
          columns : [
            {data:'nameSystem'},
            {data:'nameStation'},
            {data:'latitudeStation'},
            {data:'longitudeStation'}
          ]
      ...
      //begin function get specific
        ...
        $.ajax({
          url:"http://localhost/envirmonitoring/index.php/Station/api/stationview/id/"+variablex.idStation,
          method: 'get',
          headers: {
            'X-API-KEY':'QWERTY'
          },
          success : function(_response){
            ...
            if(_response.data == "error"){
              ...
              $(document).find('#universalForm').append(
                '<input type="hidden" id="idStation" name="idStation" value="'+_response.data.idStation+'">'
              ...
              $.toast({
               ...
               stack: 6,
                afterHidden: function () {
                  window.location = "<?=base_url('estaciones');?>";
                },
      ...
      $(document).on('click','.btn-update',function(){
        ...
        $.ajax({
          url:"http://localhost/envirmonitoring/index.php/Station/api/station/id/"+$(document).find('#idStation').val(),
          method: "PUT",
          headers : {
            'X-API-KEY':'QWERTY'
          },
          ...
          success : function(response){
            if (response.status=="success") {
              ...
              for (var i = 0; i < response.data.length; i++) {
                ...
                _html +="<option value='"+response.data[i].idSystem+"'>"+response.data[i].nameSystem+"</option>";

              }
              console.info(_html);
              $('#universalForm').find('#system').empty().append(_html); //para localizar
