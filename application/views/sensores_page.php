      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="<?=base_url('sensores');?>"><i class="fas fa-assistive-listening-systems"></i>  Sensor</a>
          </div>
        </div>
      </li>
		        ...
		        <div class="modal-dialog" role="document">
		          <div class="modal-content">
		            <div class="modal-header">
		              <h5 class="modal-title" id="exampleModalScrollableTitle">Agregar Sensor</h5>
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control" id="station" name="station">
		              ...
		              <div class="form-group">
		                <label>Nombre</label>
		                <input type="text" id="nameSensor" name="name" class="form-control">
...
<script type="text/javascript">
    ...
    // begin function get
      var table_var = $(document).find('#exportTable').DataTable({
          ajax : {
            'url':'http://localhost/envirmonitoring/index.php/Sensor/api/sensorview',
            'dataSrc':'data',
             headers :{
              'X-API-KEY':'QWERTY'
            },
